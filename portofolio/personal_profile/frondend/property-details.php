...
<body>
        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li><a href="properties.php">portofolio</a></li>
              <li><a href="property-details.php" class="active">achivement</a></li>
  ...
  <div class="page-heading header-text">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <span class="breadcrumb"><a href="#">pages</a>/achiment</span>
          <h3>Single achivement</h3>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="achivement section">
    <div class="container">
      ...
      <div class="row">
        <?php
        $menuMore = "SELECT * FROM achivement";
        ...
        ?>
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            ...
            <img src='<?= '../backend/images/achivement/' . $data['foto'] ?>' alt='' class='radius-image img-fluid' style=" width:100%; height:150px; object-fit: cover;">
              
              <div class="card-body">
                <h4 class="card-title"><?= $data['achivement'] ?></h4>
