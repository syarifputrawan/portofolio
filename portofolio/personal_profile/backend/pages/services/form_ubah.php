...
$id = $_GET['id'];
$selectid = "SELECT * FROM services WHERE id_services=$id";
...
<main>
    <div class="container-fluid px-4">
        <h1 class="mt-4">ubah data services</h1>

        <form action="<?= BASE_URL . 'aksi/services/ubah.php' ?>" method="post" enctype="multipart/form-data">

            <div class="form-group mb-3">
                <label for="">id</label>
                <input type="number" name="id_services" class="form-control" value="<?= $data['id_services'] ?>" readonly>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="project" name="description" value="<?= $data['description'] ?>" placeholder="Enter description ">
            </div>
            <div class="form-group mb-3">
...
<script>
    ...
    tampilkanGambar.src = "<?= BASE_URL . 'images/services/' . $data['foto'] ?>";
    // #####---------
