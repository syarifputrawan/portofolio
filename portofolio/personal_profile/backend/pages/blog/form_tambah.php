...
<!-- Page Heading -->
    <div class="container mt-4">
        ...
        <form action="<?= BASE_URL . 'aksi/blog/tambah.php' ?>" method="post" enctype="multipart/form-data">
        <div class="container mt-5">
        <form>
            
            <div class="form-group">
                <label for="title">blog</label>
                <input type="text" class="form-control" name="blog" placeholder="Masukkan Judul">
            </div>
            <div class="form-group">
