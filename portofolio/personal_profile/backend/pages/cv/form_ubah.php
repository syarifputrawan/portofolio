...
$id = $_GET['id'];
$selectid = "SELECT * FROM cv WHERE id_cv=$id";
...
<main>
    <div class="container-fluid px-4">
        ...
        <form action="<?= BASE_URL . 'aksi/cv/ubah.php' ?>" method="post" enctype="multipart/form-data">

            <div class="form-group mb-3">
                <label for="">id</label>
                <input type="number" name="id_cv" class="form-control" value="<?= $data['id_cv'] ?>" readonly>
            </div>
...
<script>
    ...
    tampilkanGambar.src = "<?= BASE_URL . 'images/cv/' . $data['foto'] ?>";
    // #####---------
