...
$selectid = "SELECT * FROM experience WHERE id_experience=$id";
...
<main>
    <div class="container-fluid px-4">
        <h1 class="mt-4">ubah data experience</h1>

        <form action="<?= BASE_URL . 'aksi/experience/ubah.php' ?>" method="post" enctype="multipart/form-data">

            <div class="form-group mb-3">
                <label for="">id</label>
                <input type="number" name="id_experience" class="form-control" value="<?= $data['id_experience'] ?>" readonly>
            </div>
...
<script>
    ...
    tampilkanGambar.src = "<?= BASE_URL . 'images/experience/' . $data['foto'] ?>";
    // #####---------
