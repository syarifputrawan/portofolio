...
$id = $_GET['id'];
$selectid = "SELECT * FROM pesan WHERE id_pesan=$id";
...
<main>
    <div class="container-fluid px-4">
        <h1 class="mt-4">ubah data pesan</h1>

        <form action="<?= BASE_URL . 'aksi/pesan/ubah.php' ?>" method="post" enctype="multipart/form-data">
