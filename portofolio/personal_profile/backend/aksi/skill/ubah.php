...
// berikan variabel qUpdate kosong ini
    ...
    if (!empty($passFoto)) {
        ...
        // rancang querynya
        $qUpdate = "UPDATE skill SET  skill='$skill', persen='$persen', foto ='$namaGambar' WHERE id_skill=$id";
    }else {
        // rancang querynya
        $qUpdate = "UPDATE skill SET  skill='$skill', persen='$persen'  WHERE id_skill=$id";
    }
