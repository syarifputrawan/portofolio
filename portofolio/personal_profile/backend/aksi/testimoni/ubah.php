...
if (!isset($_POST)) {
    ...
    header("location:../../pages/tsetimoni/index.php");
}
...
// berikan variabel qUpdate kosong ini
    ...
    if (!empty($passFoto)) {
        ...
        $selectBy = "SELECT foto FROM testimoni WHERE id_pesan=$id";
        ...
        $upload = move_uploaded_file($passFoto, "../../images/testimoni/$namaGambar");
        // rancang querynya
